...
// Example of overriding name
fileA.overrideName("newFileA");
console.log(`FileA's new name: ${fileA.name}`);
...
// Accessing data
console.log(`Content of fileA: ${root.getChild("folder1").getChild("newFileA").getData("content")}`);